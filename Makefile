...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Jun 16 21:08:00 2015
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtTest -I/usr/include/qt4 -Ilibflashrom -Ilibbiosext -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/home/lukasz/coreboot_flashtool/libflashrom -lflashrom -lftdi -lusb -L/home/lukasz/coreboot_flashtool/libbiosext -lbiosext -lpci -lQtTest -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): ui_mainwindow.h ui_supported.h ui_about.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents mainwindow.h utests.h supported.h about.h .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp utests.cpp supported.cpp about.cpp .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents mainwindow.ui supported.ui about.ui .tmp/flash_tool1.0.0/ && (cd `dirname .tmp/flash_tool1.0.0` && $(TAR) flash_tool1.0.0.tar flash_tool1.0.0 && $(COMPRESS) flash_tool1.0.0.tar) && $(MOVE) `dirname .tmp/flash_tool1.0.0`/flash_tool1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/flash_tool1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_utests.cpp moc_supported.cpp moc_about.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_utests.cpp moc_supported.cpp moc_about.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_supported.h ui_about.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_supported.h ui_about.h
