...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Jun 28 14:17:24 2015
...
SOURCES       = main.cpp \
		...
		addpayload.cpp \
		addcomponent.cpp \
		deletecomponents.cpp moc_mainwindow.cpp \
		moc_utests.cpp \
		moc_supported.cpp \
		moc_about.cpp \
		moc_addpayload.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents mainwindow.h utests.h supported.h about.h addpayload.h addcomponent.h deletecomponents.h .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp utests.cpp supported.cpp about.cpp addpayload.cpp addcomponent.cpp deletecomponents.cpp .tmp/flash_tool1.0.0/ && $(COPY_FILE) --parents mainwindow.ui supported.ui about.ui addpayload.ui addcomponent.ui deletecomponents.ui .tmp/flash_tool1.0.0/ && (cd `dirname .tmp/flash_tool1.0.0` && $(TAR) flash_tool1.0.0.tar flash_tool1.0.0 && $(COMPRESS) flash_tool1.0.0.tar) && $(MOVE) `dirname .tmp/flash_tool1.0.0`/flash_tool1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/flash_tool1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_utests.cpp moc_supported.cpp moc_about.cpp moc_addpayload.cpp moc_addcomponent.cpp moc_deletecomponents.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_utests.cpp moc_supported.cpp moc_about.cpp moc_addpayload.cpp moc_addcomponent.cpp moc_deletecomponents.cpp
